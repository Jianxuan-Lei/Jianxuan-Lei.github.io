...
Moreover, the generated dummy variables do not have nice labels that you can use later to tabulate your summary statistics. This means that you need to modify the labels for all the dummy variables you generated or use "collabel()" option in esttab. In my mind, both are quite troublesome.
