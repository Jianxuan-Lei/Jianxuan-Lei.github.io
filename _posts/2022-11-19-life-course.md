...
The life course of individuals is shaped by historical context, both temporally and spatially. The temporal dimension of historical context can be understood as a cohort effect and a period effect. As Elder (1994) notes, the cohort effect represents the influence of differences in birth year, which "expose individuals to different historical worlds, with their constraints and options" (p. 5).
